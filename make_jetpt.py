...
# --Set your so path, header path
ROOT.gSystem.Load("../home/twkim/Delphes3.4.2/libDelphes.so")
...
for entry in range(0, numberOfEntries):
	...
	# Plot their transverse momentum
	histMET.Fill(Metc.MET)
