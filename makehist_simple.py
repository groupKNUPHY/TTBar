...
myfile1 = root_open("powheg_nlo_bottom.root")
myfile2 = root_open("powheg_nnlo_bottom.root")
myfile3 = root_open("mad_bottom.root")
#myfile4 = root_open("delph_tt_LO.root")
#myfile5 = root_open("delph_tt_METnlo.root")
#myfile6 = root_open("delph_tt_METlo.root")
